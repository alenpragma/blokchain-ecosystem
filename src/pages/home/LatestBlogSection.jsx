...
const LatestBlogSection = () => {
  ...
  return (
    <div className="w-full bg-[#fff] md:pt-10 md:pb-28 md:px-5 px-3">
      <Container>
        ...
        <div className="grid grid-cols-12 gap-3">
          {reversedData?.slice(0, 3).map((item) => (
            <div
              key={item._id}
              className="md:col-span-4 col-span-12 h-[411px] relative md:mt-0 mt-10"
            >
