      ...
      <Container>
        <div className="mx-auto pb-6 px-5 py-10 w-3/4 ">
          ...
          <div className="flex flex-col gap-2">
            <p className="font-medium">Last updated: May 08, 2024</p>
            <p>
          ...
          <div>
            ...
            <div className="my-3">
              <h4 className="text-2xl font-semibold h4">Interpretation</h4>
              <p>
            ...
            <div className="my-3">
              <h4 className="text-2xl font-semibold h4">Definitions</h4>
              <p>For the purposes of this Privacy Policy:</p>
              <ul className="list-outside list-disc flex flex-col gap-2 ml-10">
                <li>
                ...
                <li>
                  ...
                  {`refers to Biztoken Mining, the software program provided by the Company.`}
                </li>
                <li>
                  <span className="font-semibold">Company :</span>{" "}
                  {`(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Biz Token Ltd., 71-75, Shelton Street, Covent Garden, London, WC2H 9JQ, United Kingdom.`}
                </li>
                <li>
          ...
          <div>
            ...
            <div>
              ...
              <div className="my-3">
                <h5 className="text-[20px] font-semibold">Personal Data</h5>
                <p>
                ...
                <div className="my-3">
                  <ul className="list-outside list-disc flex flex-col ml-10">
                    <li>{"Email address"}</li>
              ...
              <div className="my-3">
                <h5 className="text-[20px] font-semibold">Usage Data</h5>
                <p>
            ...
            <div>
              ...
              <ul className="list-outside list-disc flex flex-col gap-2 ml-5">
                <li>
            ...
            <div>
              ...
              <h5 className="text-[20px] font-semibold">Law enforcement</h5>
              <p>
          ...
          <div>
            <h3 className="text-3xl font-semibold my-3">Children's Privacy</h3>
            <p>
          ...
          <div>
            <h3 className="text-3xl font-semibold my-3">Contact Us</h3>
            <p>
            ...
            <ul className="list-outside list-disc flex flex-col ml-10">
              ...
              <li>
                {
                  "By visiting this page on our website: https://www.bizeglobal.com/contact-us"
                }
              </li>
            </ul>
          </div>
